      ...
      {contacts.map((c, i) => {
        ...
        return (
          <motion.div
            ...
            onClick={() => onSelect(c)}
            className={`group grid cursor-pointer grid-cols-[1fr_1.5fr_110px_90px_90px_40px] items-start border-b border-border/40 px-6 py-3 transition-all duration-100 hover:bg-white/[0.025] min-w-[700px] ${
              c.done ? "opacity-40" : ""
            }`}
          >
            {/* Name + company */}
